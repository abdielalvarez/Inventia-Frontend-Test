...
import { ROUTE_SUCCESSSTORIES_BANKINGION } from "@/utils/routes";
            ...
            <div className={styles.wrapper}>
                <div className={styles.container}>
                    ...
                    <div className={styles.container2}>
                        <Image
                            src="/images/success-stories/banking-financierapodemosprogresar/success/illustration.jpg"
                            alt="Success"
                        ...
                        <div>
                            ...
                            <Link href={ROUTE_SUCCESSSTORIES_BANKINGION}>
